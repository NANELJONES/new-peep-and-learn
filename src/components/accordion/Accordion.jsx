    ...
    function SearchFAQ({data}){
                ...
                return(
                    ...
                    {data.filter((val)=>{
                            if(searchFAQ == ""){
                                return val
                            }else if( val.heading.toLowerCase().includes(searchFAQ.toLowerCase()) ){
                                return val
                            }}).map((item, i) =>(
                            <div className="item"   onClick={() => toggle(i) }>
                                    <div className={selected == i ? "title show" :"title"} >
    ...
    function pageBackward(){
      ...
      function MakeChanges(){
            ...
            if(inputRef.current.value == ""){
                ...
                setSearchFAQ(inputRef.current.value)
                setPageNo(0)
            }
    ...
    return (
        <div id="all_acc">
            <div className='search_box'  id="search_box" >
                <input type="text" placeholder='Search asked questions' ref  ={inputRef} onChange={e => {MakeChanges()}}/>
            ...
            <div className="Allocator_div">
                ...
                {pageno == 0 ? <SearchFAQ data = {all_info}/>: null }
